                ...
                for g in range(len(dt_b)):
                    ...
                    if chunk in final_subject_for_svod_pair:
                        if counter_of_chunk <= 1:
                            ...
                            final_date_time_for_svod_pair.append(''.join([dt_b[g],'']))
                        if counter_of_chunk >= 2:
                            ...
                            while f != counter_of_chunk:
                                ...
                                f += 1
                            filtered_part = final_subject_for_svod_pair[all_recurring_box[0]:all_recurring_box[-1]+len(dt_b[g])]
                        ...
                        if counter_of_chunk >= 2:
                            ...
                            while f != counter_of_chunk:
                                ...
                                f += 1
                            filtered_part = final_object_for_svod_pair[all_recurring_box[0]:all_recurring_box[-1] + len(dt_b[g])]
